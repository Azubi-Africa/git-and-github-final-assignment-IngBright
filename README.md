...
| 2 |  - Shop Manager Analysis             |  -    This analysis gave insights to the shop manager and He was able to make key decisions from the analysis.           |    https://github.com/IngBright/Shop-Manager-Analysis.git    |
| 3 |  -    Python Class Some Time Ago         |  -  These codes were to calculate the mortgage after inputting the principal, the time for repayment, and the rate at which one will make the payments.            |    https://github.com/IngBright/Python-Class-Some-Time-Ago.git     |
    |
